...
function setup() {
  ...
  indexAtWhichTheRestOfWordsAreInItalic = 5;

  //now create and add the rectangles to the world
  for (var i = 0; i < words.length; i++) {
    if (i < indexAtWhichTheRestOfWordsAreInItalic) {
      //initially the text style is bold see https://p5js.org/reference/#/p5/textStyle
      textStyle(BOLD);
    } else {
      //after the split, they are italic
      textStyle(ITALIC);
    }
  ...
  backgroundColours = [color(235, 59, 86), color(235, 59, 86)];

  lineColours = [color(255, 255, 255, 255), color(255, 255, 255, 255)];
