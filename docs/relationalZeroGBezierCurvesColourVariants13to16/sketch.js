...
function setup() {
  ...
  colourChoice = ['Variant 13', 'Variant 14', 'Variant 15', 'Variant 16'];
  ...
  wordBackgroundColours = [
    [color(73, 164, 183), color(98, 95, 90), color(235, 60, 82), color(235, 60, 82)],
    [color(238, 221, 123), color(238, 221, 123), color(187, 181, 74), color(108, 34, 61)],
    [color(238, 221, 123), color(238, 221, 123), color(163, 162, 73), color(108, 34, 61)],
    [color(73, 164, 183), color(98, 95, 90), color(137, 193, 161), color(235, 60, 82)],
    [color(73, 164, 183), color(98, 95, 90), color(137, 193, 161), color(146, 196, 209)],
    [color(203, 84, 71), color(203, 84, 71), color(44, 75, 118), color(249, 253, 121)],
    [color(203, 84, 71), color(203, 84, 71), color(44, 75, 118), color(249, 253, 121)],
    [color(203, 84, 71), color(203, 84, 71), color(235, 60, 82), color(146, 196, 209)],
    [color(134, 190, 152), color(73, 164, 183), color(187, 181, 74), color(73, 102, 163)],
    [color(203, 84, 71), color(203, 84, 71), color(44, 75, 118), color(235, 60, 82)],
  ];

  wordColours = [
    [color(255, 255, 255), color(255, 255, 255), color(255, 255, 255), color(237, 230, 221)],
    [color(68, 65, 71), color(68, 65, 71), color(255, 255, 255), color(237, 230, 221)],
    [color(68, 65, 71), color(68, 65, 71), color(255, 255, 255), color(237, 230, 221)],
    [color(255, 255, 255), color(255, 255, 255), color(255, 255, 255), color(237, 230, 221)],
    [color(255, 255, 255), color(255, 255, 255), color(255, 255, 255), color(237, 230, 221)],
    [color(255, 255, 255), color(255, 255, 255), color(255, 255, 255), color(237, 230, 221)],
